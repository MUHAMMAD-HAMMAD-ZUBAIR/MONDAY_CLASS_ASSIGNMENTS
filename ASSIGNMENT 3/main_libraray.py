...
def main():
    console.print(Panel("📚 [bold cyan]M.H.Z Intelligent Library Assistant[/]", subtitle="Made by M.H.Z", style="bright_blue"))
    ...
    while True:
        ...
        try:
            ...
            console.print(Panel(f"[bold white]{result.final_output}[/]", title="🤖 M.H.Z Agent Reply", style="green"))
